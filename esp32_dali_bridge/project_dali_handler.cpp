...
unsigned long daliRxCount = 0;
unsigned long daliTxCount = 0;
unsigned long daliErrorCount = 0;

void incrementRxCount() { daliRxCount++; }
void incrementTxCount() { daliTxCount++; }
void incrementErrorCount() { daliErrorCount++; }
