...
#ifdef DEBUG_SERIAL
    Serial.printf("[STATUS] Uptime: %lus | Heap: %.1fKB | RX: %lu | TX: %lu | Errors: %lu | Address: %d | Level: %d (%.1f%%)\n",
                  stats.uptime_seconds, stats.free_heap_kb, stats.messages_rx, stats.messages_tx, stats.errors,
                  ballastState.short_address, ballastState.actual_level, (ballastState.actual_level / 254.0) * 100.0);
#endif
