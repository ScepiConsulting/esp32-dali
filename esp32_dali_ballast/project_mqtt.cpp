...
String appMqttTopicsHTML() {
  ...
  html += "<p style=\"margin:12px 0 4px 0;color:var(--text-secondary);\"><strong>" + String(tr("Előtét állapota:", "Ballast Status:")) + "</strong> <code style=\"background:var(--bg-primary);padding:2px 6px;border-radius:3px;font-family:monospace;\">" + mqtt_prefix + "ballast_status</code></p>";
  html += "<p style=\"margin:0 0 8px 0;font-size:12px;color:var(--text-secondary);\">" + String(tr("Publikálva az előtét állapotának változásakor (szint, fényerő-átmenet stb.)", "Published when ballast state changes (level, fade, etc.)")) + "</p>";
  html += "<details style=\"margin:8px 0;padding:8px;background:var(--bg-primary);border-radius:4px;\">";
  html += "<summary style=\"cursor:pointer;color:var(--accent-green);font-weight:500;\">▸ " + String(tr("Példa: Előtét állapota", "Example: Ballast Status")) + "</summary>";
  ...
  html += "<p style=\"margin:12px 0 4px 0;color:var(--text-secondary);\"><strong>" + String(tr("Fogadott parancsok:", "Commands Received:")) + "</strong> <code style=\"background:var(--bg-primary);padding:2px 6px;border-radius:3px;font-family:monospace;\">" + mqtt_prefix + "command</code></p>";
  html += "<p style=\"margin:0 0 8px 0;font-size:12px;color:var(--text-secondary);\">" + String(tr("Publikálva, amikor az előtét DALI parancsot kap a buszról", "Published when ballast receives DALI commands from the bus")) + "</p>";
  html += "<details style=\"margin:8px 0;padding:8px;background:var(--bg-primary);border-radius:4px;\">";
  html += "<summary style=\"cursor:pointer;color:var(--accent-green);font-weight:500;\">▸ " + String(tr("Példa: Szintbeállító parancs", "Example: Set Level Command")) + "</summary>";
  ...
  html += "<details style=\"margin:8px 0;padding:8px;background:var(--bg-primary);border-radius:4px;\">";
  html += "<summary style=\"cursor:pointer;color:var(--accent-green);font-weight:500;\">▸ " + String(tr("Példa: Lekérdezés válasza", "Example: Query Response")) + "</summary>";
  ...
  html += "<p style=\"margin:12px 0 4px 0;color:var(--text-secondary);\"><strong>" + String(tr("Konfiguráció:", "Configuration:")) + "</strong> <code style=\"background:var(--bg-primary);padding:2px 6px;border-radius:3px;font-family:monospace;\">" + mqtt_prefix + "config</code></p>";
  html += "<p style=\"margin:0 0 8px 0;font-size:12px;color:var(--text-secondary);\">" + String(tr("Az előtét konfigurációja publikálva csatlakozáskor és változáskor", "Ballast configuration published on connect and when changed")) + "</p>";
  html += "<details style=\"margin:8px 0;padding:8px;background:var(--bg-primary);border-radius:4px;\">";
  html += "<summary style=\"cursor:pointer;color:var(--accent-green);font-weight:500;\">▸ " + String(tr("Példa: Konfiguráció", "Example: Configuration")) + "</summary>";
  ...
  html += "<p style=\"margin:12px 0 4px 0;color:var(--text-secondary);\"><strong>" + String(tr("Eszköz állapota:", "Device Status:")) + "</strong> <code style=\"background:var(--bg-primary);padding:2px 6px;border-radius:3px;font-family:monospace;\">" + mqtt_prefix + "status</code></p>";
  html += "<p style=\"margin:0 0 8px 0;font-size:12px;color:var(--text-secondary);\">" + String(tr("Az eszköz online/offline állapota üzemidővel és IP-címmel", "Device online/offline status with uptime and IP address")) + "</p>";
  html += "<details style=\"margin:8px 0;padding:8px;background:var(--bg-primary);border-radius:4px;\">";
  html += "<summary style=\"cursor:pointer;color:var(--accent-green);font-weight:500;\">▸ " + String(tr("Példa: Eszköz állapota", "Example: Device Status")) + "</summary>";
  ...
  html += "<p style=\"margin:12px 0 4px 0;color:var(--text-secondary);\"><strong>" + String(tr("Diagnosztika:", "Diagnostics:")) + "</strong> <code style=\"background:var(--bg-primary);padding:2px 6px;border-radius:3px;font-family:monospace;\">" + mqtt_prefix + "diagnostics</code></p>";
  html += "<p style=\"margin:0 0 8px 0;font-size:12px;color:var(--text-secondary);\">" + String(tr("Rendszeresen publikálva üzenetszámlálókkal és hibaszámokkal", "Published periodically with message counters and error counts")) + "</p>";
  html += "<details style=\"margin:8px 0;padding:8px;background:var(--bg-primary);border-radius:4px;\">";
  html += "<summary style=\"cursor:pointer;color:var(--accent-green);font-weight:500;\">▸ " + String(tr("Példa: Diagnosztika", "Example: Diagnostics")) + "</summary>";
