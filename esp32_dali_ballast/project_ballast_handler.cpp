...
unsigned long ballastRxCount = 0;
unsigned long ballastTxCount = 0;
unsigned long ballastErrorCount = 0;

void incrementRxCount() { ballastRxCount++; }
void incrementTxCount() { ballastTxCount++; }
void incrementErrorCount() { ballastErrorCount++; }
